# Creative Generation — AI Image, Caption & Hashtag Pipeline
...
- [Creative Generator auto-starts after planner completes](#creative-generator-auto-starts-after-planner-completes)
- [Creative Generator validates all required plan fields](#creative-generator-validates-all-required-plan-fields)
- [Image is generated as real binary data from gpt-image-1](#image-is-generated-as-real-binary-data-from-gpt-image-1)
- [Generated image is displayed inline in the chat](#generated-image-is-displayed-inline-in-the-chat)
- [Caption length is between 100 and 300 characters](#caption-length-is-between-100-and-300-characters)
- [Caption is a single text block with no line breaks](#caption-is-a-single-text-block-with-no-line-breaks)
- [Caption is displayed in the creative preview](#caption-is-displayed-in-the-creative-preview)
- [Hashtag count is between 5 and 10](#hashtag-count-is-between-5-and-10)
- [Each hashtag starts with # and contains no spaces](#each-hashtag-starts-with-and-contains-no-spaces)
- [Duplicate hashtags are removed](#duplicate-hashtags-are-removed)
- [Hashtags are displayed as chips in the creative preview](#hashtags-are-displayed-as-chips-in-the-creative-preview)
- [Initial status message appears immediately when generation starts](#initial-status-message-appears-immediately-when-generation-starts)
- [Follow-up status message appears after 15 seconds](#follow-up-status-message-appears-after-15-seconds)
- [Third status message appears after 40 seconds](#third-status-message-appears-after-40-seconds)
- [Completion status message appears when generation finishes](#completion-status-message-appears-when-generation-finishes)
- [Image is accessible via campaign image URL](#image-is-accessible-via-campaign-image-url)
- [Image URL is stable across page refreshes](#image-url-is-stable-across-page-refreshes)
- [Creative preview shows image, caption, and hashtags together](#creative-preview-shows-image-caption-and-hashtags-together)
- [Generating stage becomes active when creative generation starts](#generating-stage-becomes-active-when-creative-generation-starts)
- [Generating stage becomes completed when creative generation finishes](#generating-stage-becomes-completed-when-creative-generation-finishes)
- [Auto-handoff signal sent to Copy Reviewer after creative completes](#auto-handoff-signal-sent-to-copy-reviewer-after-creative-completes)
- [Timeline transitions to Reviewing after creative handoff](#timeline-transitions-to-reviewing-after-creative-handoff)
- [Transparent retry on transient image generation failure](#transparent-retry-on-transient-image-generation-failure)
- [Error message and retry button after all 3 attempts fail](#error-message-and-retry-button-after-all-3-attempts-fail)
- [Retry button is visible and functional on generation failure](#retry-button-is-visible-and-functional-on-generation-failure)
- [Image preserved when caption generation fails separately](#image-preserved-when-caption-generation-fails-separately)
- [Exponential backoff between retry attempts](#exponential-backoff-between-retry-attempts)
