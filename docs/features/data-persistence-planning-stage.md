# Data Persistence — Planning Stage
...
- [Brief and plan are persisted after planner completes](#brief-and-plan-are-persisted-after-planner-completes)
- [Persisted campaign can be retrieved by ID](#persisted-campaign-can-be-retrieved-by-id)
- [Workflow does not advance when persistence fails](#workflow-does-not-advance-when-persistence-fails)
- [Campaign ID is returned on creation](#campaign-id-is-returned-on-creation)
